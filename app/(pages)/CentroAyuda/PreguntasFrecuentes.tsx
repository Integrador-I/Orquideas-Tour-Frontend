  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="space-y-4">
        {faqs.map((faq, index) => (
          <div key={index} className="border border-blue-200 rounded-lg overflow-hidden bg-white">
            <button
            ...
            {activeIndex === index && (
              <div className="p-6 bg-blue-50 border-t border-blue-200">
                ...
                <span className={`inline-block mt-3 px-3 py-1 text-xs font-semibold rounded-full ${
                  faq.category === 'boletos' ? 'bg-blue-200 text-blue-800' : 'bg-blue-300 text-blue-900'
                }`}>
