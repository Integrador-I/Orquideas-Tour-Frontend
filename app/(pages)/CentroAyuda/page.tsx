...
export default function CentroAyuda() {
  ...
  return (
    <div className="bg-blue-50 min-h-screen">
      ...
      <div className="bg-gradient-to-r from-blue-400 to-blue-600 text-white py-25">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">Centro de Ayuda</h1>
          <p className="text-xl mb-8 text-white-100">¿En qué podemos ayudarte hoy?</p>
          <div className="max-w-2xl mx-auto relative">
            <input
              type="text"
              placeholder="Buscar en ayuda (ej: 'cancelar boleto', 'rastrear encomienda')"
              className="w-full py-4 px-6 rounded-full text-white-800 focus:outline-none focus:ring-2 focus:ring-blue-300 shadow-md"
            />
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="my-16">
          <h2 className="text-3xl font-bold text-center mb-12 text-white-700">Preguntas Frecuentes</h2>
          <PreguntasFrecuentes />
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-500 to-blue-700 rounded-xl p-8 text-white flex flex-col md:flex-row items-center justify-between shadow-lg">
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-white-100">Nuestro equipo está disponible para ayudarte</p>
          </div>
          <Button/>
        </div>
      </div>
